...
import csv #import modules to work with data
import datetime
f = open('guns.csv', 'r')
...
headers = data[0]
data = data[1:] #removed header row from data and stored it in headers
print(data[0:5])
...
year_counts = {} #Counting gun deaths per year
...
# In[6]: #Gun deaths by year and month
...
# In[9]:
#Reading in census.csv to make findings more relative and accurate
...
# In[14]:
# Gun deaths per race per 100000 (to make it more relative)
